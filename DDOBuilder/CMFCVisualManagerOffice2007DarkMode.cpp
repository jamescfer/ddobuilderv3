...
// Called by the OnEraseBackground helper for every pane's client area.
// ---------------------------------------------------------------------------
void CMFCVisualManagerOffice2007DarkMode::OnFillPopupWindowBackground(CDC* pDC, CRect rect)
{
    ASSERT_VALID(pDC);
